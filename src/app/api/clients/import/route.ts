...
const csvClientSchema = z.object({
  ...
  director_name: z.string().optional().default(''),
  ...
  tpas_authorised: z.union([z.boolean(), z.string()]).optional().default(false),
  ...
  payroll_contact_name: z.string().optional().default(''),
  payroll_contact_email: z.string().email().optional().or(z.literal('')).default(''),
  payroll_contact_phone: z.string().optional().default(''),
})
  ...
  try {
    ...
    for (let batchStart = 0; batchStart < clients.length; batchStart += BATCH_SIZE) {
      ...
      const clientRows = batch.map((c) => ({
        ...
        tpas_authorised: parseBool(c.tpas_authorised),
        ...
        payroll_contact_name: c.payroll_contact_name || null,
        payroll_contact_email: c.payroll_contact_email || null,
        payroll_contact_phone: c.payroll_contact_phone || null,
