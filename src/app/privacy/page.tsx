        ...
        >
          ...
          >
            ...
            <section>
              ...
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Account Data:</strong> Your name, email address, and password (hashed) when you register for an account.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Profile Data:</strong> Your profile photo (optional), display name, and account preferences.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Client Data:</strong> Information you enter about your payroll clients, including company names, PAYE references, contact details, payroll configurations, and employee counts. This data is entered and controlled by you.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Usage Data:</strong> Information about how you interact with the Service, including pages visited, features used, and timestamps of activity.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Technical Data:</strong> IP address, browser type, device information, and cookies (see Section 7).</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Contract (Article 6(1)(b)):</strong> Processing necessary to perform our contract with you (providing the Service).</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Legitimate Interests (Article 6(1)(f)):</strong> Processing necessary for our legitimate interests, such as improving the Service, preventing fraud, and ensuring security, where these interests are not overridden by your rights.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Consent (Article 6(1)(a)):</strong> Where you have given specific consent, such as opting into marketing communications. You may withdraw consent at any time.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Legal Obligation (Article 6(1)(c)):</strong> Where we need to process data to comply with a legal obligation.</p>
            </section>
                ...
                <table className="w-full text-sm border-collapse min-w-[420px]">
                  <thead>
                    <tr style={{ borderBottom: '1px solid var(--mkt-border)' }}>
                      <th className="text-left py-2 pr-4 font-semibold" style={{ color: 'var(--mkt-text)' }}>Provider</th>
                      <th className="text-left py-2 pr-4 font-semibold" style={{ color: 'var(--mkt-text)' }}>Purpose</th>
                      <th className="text-left py-2 font-semibold" style={{ color: 'var(--mkt-text)' }}>Location</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr style={{ borderBottom: '1px solid var(--mkt-border)' }}>
            ...
            <section>
              ...
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Essential Cookies:</strong> Required for authentication and security. These cannot be disabled as the Service will not function without them.</p>
              <p className="mt-3"><strong style={{ color: 'var(--mkt-text)' }}>Preference Cookies:</strong> Store your settings such as theme preference (light/dark mode). These improve your experience but are not strictly necessary.</p>
              <p className="mt-3">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1 mt-2">
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right of Access:</strong> Request a copy of the personal data we hold about you</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Rectification:</strong> Request correction of inaccurate or incomplete data</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Erasure:</strong> Request deletion of your personal data (&ldquo;right to be forgotten&rdquo;)</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Data Portability:</strong> Request your data in a structured, machine-readable format</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Restrict Processing:</strong> Request that we limit how we use your data</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Object:</strong> Object to processing based on legitimate interests</li>
                <li><strong style={{ color: 'var(--mkt-text)' }}>Right to Withdraw Consent:</strong> Where processing is based on consent, withdraw it at any time</li>
              </ul>
              <p className="mt-3">
