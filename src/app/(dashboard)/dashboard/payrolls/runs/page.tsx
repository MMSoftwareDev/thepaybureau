...
function PayrollsPage() {
  ...
  const payrollFilter = searchParams.get('payroll')
  ...
  const fetchRuns = useCallback(async () => {
    try {
      ...
      if (payrollFilter) {
        query = query.eq('payroll_id', payrollFilter)
  ...
  }, [supabase, clientFilter, payrollFilter, currentPeriod])

  useEffect(() => {
    if (mounted) fetchRuns()
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [clientFilter, payrollFilter, currentPeriod, mounted])
